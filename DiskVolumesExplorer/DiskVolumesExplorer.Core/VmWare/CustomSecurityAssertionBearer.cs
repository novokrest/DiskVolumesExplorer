...
{
    /// <summary>
    /// Obtained from VmWare SDK Samples
    /// </summary>
    /// 
    /// <summary>
    ...
    {
        readonly IssuedToken _issuedToken;
        ...
        {
            _issuedToken = new IssuedToken(parentAssertion.BinaryToken);
        }
        ...
        {
            security.Tokens.Add(_issuedToken);
        }
    }
}
